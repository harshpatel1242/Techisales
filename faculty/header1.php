...
$sql1 = "SELECT * FROM mt_emp  
		WHERE EMP_NO = '$empname'";
...
<html>
<head>
<title>Faculty Appraisal System</title>
<style type="text/css"> 
  body
    {
      height:100%;
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <a class="navbar-brand"  href="#"><span class="fa fa-area-chart"></span> Appraisal <span class="dashboard_text">System Dashboard <br><?php echo "$role"; ?><?php echo "$dept_id"; ?></span></a>
          </div>
            ...
            <ul class="sidebar-menu">
			 <li class="treeview">
				<br>
                  ...
                  <li><a href="f1.php" style='display:<?php if ($role != "principal"  ){  echo "block";  }  else{ echo "none";  } ?>'>Faculty appraisal form </a></li>
				  
				
                 <li><a href="emp_status.php" style='display:<?php if ($role != 'principal' ){  echo "block";  }  else{ echo "none";  } ?>'> My Appraisal form </a></li>   
					...
					<ul>
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								...
								<!-- for profile image -->	
									<span class="prfil-img"><img src="<?php echo $profile ; ?>" alt="" height="50" width="50"> </span> 
									<div class="user-name">
