...
{
    $query = "UPDATE mt_appraisal SET PRINCIPAL_APPROVED = 'Approved',PRINCIPAL_APPROVED_DATE = '$pr_date',PRINCIPAL_REMARKS='$remark',PR_APP_ID='$empname'
                   WHERE FORM_ID = '$l' ";
...
{
    $query = "UPDATE mt_appraisal SET PRINCIPAL_APPROVED = 'Review',PRINCIPAL_APPROVED_DATE = '$pr_date',PRINCIPAL_REMARKS='$remark',PR_APP_ID='$empname' 
    WHERE FORM_ID = '$l' ";
$res = mysqli_query($conn , $query);
    $res = mysqli_query($conn , $query);
    if($res)
...
<head>
  ...
  <script>
        ...
        function calculate(){
            var num1,num2,num3;
            num1=parseFloat(_('fmcq').value); 
            num2=parseFloat(_('sw').value); 
        ...
        function grade(){
          var num3=parseFloat(_('total').value); 
            if(num3>80  && num3<=100)   {   _('grade').innerHTML   ='O';  }
            else if(num3>70 && num3<=80){   _('grade').innerHTML   ='A';   }
            else if(num3>60 && num3<=70){   _('grade').innerHTML   = 'B';  }
            else if(num3>50 && num3<=60){   _('grade').innerHTML   ='C'; }
            else if(num3>34 && num3<=50){   _('grade').innerHTML   ='D';  } 
            else                        {   _('grade').innerHTML   ='E ';} 
        }
...
?>
                              ...
                              <!-- the switching function does not work -->
                                ...
                                <tr>
                                  ...
                                  <td  style="width:15%;">
                                  <div >
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="36" <?php if($mcq36==2.0){echo "checked";} else{echo "disabled";} ?> > Excellent</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="36" <?php if($mcq36==1.4){echo "checked";} else{echo "disabled";} ?> > Good</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="36" <?php if($mcq36==1.0){echo "checked";} else{echo "disabled";} ?>> Average</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="36" <?php if($mcq36==0.4){echo "checked";} else{echo "disabled";} ?>> Poor</label></div>
                                  </div>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td  style="width:15%;">
                                  <div >
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="37" <?php if($mcq37==2.0){echo "checked";} else{echo "disabled";} ?> > Excellent</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="37" <?php if($mcq37==1.4){echo "checked";} else{echo "disabled";} ?> > Good</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="37" <?php if($mcq37==1.0){echo "checked";} else{echo "disabled";} ?>> Average</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="37" <?php if($mcq37==0.4){echo "checked";} else{echo "disabled";} ?>> Poor</label></div>
                                  </div>
                                  </td>
                                </tr>	
                                <tr>
                                  ...
                                  <td  style="width:15%;">
                                  <div >
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="38" <?php if($mcq38==2.0){echo "checked";} else{echo "disabled";} ?> > Excellent</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="38" <?php if($mcq38==1.4){echo "checked";} else{echo "disabled";} ?> > Good</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="38" <?php if($mcq38==1.0){echo "checked";} else{echo "disabled";} ?>> Average</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="38" <?php if($mcq38==0.4){echo "checked";} else{echo "disabled";} ?>> Poor</label></div>
                                  </div>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td  style="width:15%;">
                                  <div >
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="39" <?php if($mcq39==2.0){echo "checked";} else{echo "disabled";} ?> > Excellent</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="39" <?php if($mcq39==1.4){echo "checked";} else{echo "disabled";} ?> > Good</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="39" <?php if($mcq39==1.0){echo "checked";} else{echo "disabled";} ?>> Average</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="39" <?php if($mcq39==0.4){echo "checked";} else{echo "disabled";} ?>> Poor</label></div>
                                  </div>
                                  </td>
                                </tr>	
                                <tr>
                                  ...
                                  <td  style="width:15%;">
                                  <div >
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="40" <?php if($mcq40==2.0){echo "checked";} else{echo "disabled";} ?> > Excellent</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="40" <?php if($mcq40==1.4){echo "checked";} else{echo "disabled";} ?> > Good</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="40" <?php if($mcq40==1.0){echo "checked";} else{echo "disabled";} ?>> Average</label></div>
                                    <div class="radio-inline" style="margin-left:15px;margin-right:15px;"><label><input type="radio"  name="40" <?php if($mcq40==0.4){echo "checked";} else{echo "disabled";} ?>> Poor</label></div>
                                  </div>
                                  </td>
                                </tr>
                                </table>    
              ...
              <div id="phase4">
                                  ...
                                  <div class="form-group">
                                    <label for="name" class="col-sm-4 control-label" >total weight other than other performance  :</label>
                                    <div class="col-sm-1">
                                      <input  type="text" class="form-control1" name="avg" id="avg" placeholder=""  value='<?php echo "$tt";?>' readonly>
                                    </div>
                                    
                                    <label for="employee no." class="col-sm-4 control-label">total weight in other performance</label>
                                    <div class="col-sm-1">
                                      <input type="text" class="form-control1" name="fmcq" id="fmcq" placeholder="" value='<?php echo "$f_mcq";?>' 	readonly>
                                    </div>
                                  ...
                                  <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label" > hod remarks :</label>
                                    <div class="col-sm-6">
                                      <input  type="text" class="form-control1" name="hod_remarks" id="hod_remarks" placeholder="" value="<?php echo "$hod_remark"; ?>" readonly>
                                    </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                      <input  type="text" class="form-control1" name="pr_remark" placeholder=""  >
                                    </div>
                                    <label for="date" class="col-sm-1 control-label" style="" >Date :</label>
                                    <div class="col-sm-2" >
                                      <input type="date" class="form-control1" id="pr_date" placeholder="" name="pr_date"
                                      value="<?php echo date("Y-m-d");?>" readonly>
                                    </div>
